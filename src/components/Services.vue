<template>
  <div class="services" id="services">
      ...
      <div class="services__text--title">
          <h1 class="services__text--title">Contact us @ Gurdeep Singh </h1><h1 class="services__text--title"> Mob. 7982419813 </h1>
      </div>
  </div>
</template>
...
export default {
  ...
  data: () => ({
    slides: [
    //   "https://www.pnbmetlife.com/content/dam/pnb-metlife/images/hero-banner/desktop/mmwp-categorypage-1d.jpg",
      "https://online.pnbmetlife.com/meratermplanplus/assets/images/homebanner-leftImg.png",
      "https://www.pnbindia.in/LifeInsurance/Pm/ch-images/product/mobile-mssp.jpg",
    //   "https://www.pnbmetlife.com/content/dam/pnb-metlife/images/hero-banner/desktop/new/mggp_cate_3vd.jpg",
    //   "https://www.pnbmetlife.com/content/dam/pnb-metlife/images/hero-banner/mobile/mgfp_cate_3vd.jpg",
    ],
  }),
};
